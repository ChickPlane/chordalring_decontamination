...
\section{Analysis and Comparsion}
...
\bibitem{EE1}J. Chalopin, S.Das, A. Labourel, and E. Markou. Black hole search with finite automata scattered in a synchronous torus. 25th International Symposium on Distributed Computing (DISC), 432–446, 2011.
\bibitem{EE2}C. Cooper, R. Klasing, and T. Radzik. Searching for black-hole faults in a network using multiple agents. 10th International Conference on Principles of Distributed Systems (OPODIS), 320–332, 2006.
\bibitem{EE3}J. Czyzowicz, S. Dobrev, R. Kr´alovic, S. Mikl´ık, and D. Pardubsk´a. Black hole search in directed graphs. 16th International Colloquium on Structural Information and Communication Complexity (SIROCCO), 182–194, 2009.
\bibitem{EE4}S. Dobrev, P. Flocchini, R. Kr´alovic, P. Ruzicka, G. Prencipe, and N. Santoro. Black hole search in common networks. Networks, 47(2):61–71, 2006.
\bibitem{EE5}S. Dobrev, P. Flocchini, G. Prencipe, and N. Santoro. Searching for a black hole in arbitrary networks: Optimal mobile agents protocols. Distributed Computing, 19(1):1–19, 2006.
\bibitem{EE6}S. Dobrev, P. Flocchini, and N. Santoro. Mobile search for a black hole in an anonymous ring. Algorithmica, 48:67–90, 2007.
\bibitem{EE7}P. Glaus. Locating a black hole without the knowledge of incoming link. 5th Int. Workshop on Algorithmic Aspects of Wireless Sensor Networks (ALGOSENSOR), 128–138, 2009.
\bibitem{EE8}R. Klasing, E. Markou, T. Radzik, and F. Sarracco. Approximation bounds for black hole search problems. Networks, 52(4):216–226, 2008.

\bibitem{EF1}L. Barri`ere, P. Flocchini, P. Fraignaud, and N. Santoro. Capture of an intruder by mobile agents. 14th Symposium on Parallel Algorithms and Architectures (SPAA), 200-209, 2002.
\bibitem{EF2}L. Blin, P. Fraignaud, N. Nisse, and S. Vial. Distributed chasing of network intruders. Theoretical Computer Science 399 (1-2): 12-37. 2008.
\bibitem{EF3}P. Flocchini, M.J. Huang, and F.L. Luccio. Decontamination of hypercubes by mobile agents. Networks 52 (3): 167-178, 2008.
\bibitem{EF4}P. Flocchini, M.J. Huang, and F.L. Luccio. Decontaminating chordal rings and tori using mobile agents. International Journal on Foundations of Computer Science 18 (3): 547-563, 2006.
\bibitem{EF5}P. Flocchini, F.L. Luccio, and L.X. Song. Size optimal strategies for capturing an intruder in mesh networks. International Conference on Communications in Computing (CIC), 200-206, 2005.
\bibitem{EF6}F.V. Fomin, D.M. Thilikos, and I. Todineau. Connected graph searching in outerplanar graphs. 7th International Conference on Graph Theory (ICGT), 2005.
\bibitem{EF7}N. Imani, H. Sarbazi-Azadb, and A.Y. Zomaya. Capturing an intruder in product networks. Journal of Parallel and Distributed Computing 67 (9): 1018–1028, 2007.
\bibitem{EF8}N. Imani, H. Sarbazi-Azad, A.Y. Zomaya, and P. Moinzadeh. Detecting threats in star graphs. IEEE Trans. Par. and Dist. Systems 20 (4): 474- 483 , 2009.
\bibitem{EF9}F.L. Luccio Contiguous search problem in Sierpinski graphs. Theory of Computing Systems 44(2): 186-204, 2009.
\bibitem{EFa}F. Luccio and L. Pagli. A general approach to toroidal mesh decontamination with local immunity. 23rd IEEE International Parallel and Distributed Processing Symposium (IPDPS), 1-8, 2009.
\bibitem{EFb}F. Luccio, L. Pagli, and N. Santoro. Network decontamination in presence of local immunity. Int. J. Foundation of Computer Science 18(3): 457–474, 2007.
\bibitem{EFc}N. Nisse. Connected graph searching in chordal graphs. Discrete Applied Mathematics 157 (12): 2603-2610, 2009

\bibitem{EG1}J. Cai, P. Flocchini, N. Santoro. Distributed Black Virus Decontamination and Rooted Acyclic Orientations. 2015 IEEE International Conference on Computer and Information Technology; Ubiquitous Computing and Communications; Dependable, Autonomic and Secure Computing; Pervasive Intelligence and Computing
\bibitem{EH1}M. Alotaibi. Black Virus Disinfection in Chrodal Rings. University of Ottawa. 2014
\end{thebibliography}
